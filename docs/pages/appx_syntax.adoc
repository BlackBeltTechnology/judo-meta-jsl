...
|bind          | boolean literal                        | If the transfer field is changed, its value will be set into the mapped entity's field.
|====================
...
|identity      | transfer object field       | The identifier field of a mapped transfer object.
