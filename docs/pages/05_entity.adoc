...
* compositions and fields with no parameters use embedded loading

* relations use query loading

* calculated members that have parameters use query loading
...
To apply the query fetching strategy on an entity member, use the `@Query` annotation.
