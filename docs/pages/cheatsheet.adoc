...
Note that `@Embedded` and `@Query` annotations cannot be used on the same target at the same time.
...
|====================
|Annotation | Meaning
|@Query     | Do not fetch the composite object(s) together with the entity.
...
|====================
|Annotation  | Meaning
|@Query      | Do not fetch the related object(s) with the entity.
...
|====================
|Annotation  | Meaning
|@Query      | Do not fetch the value together with the entity.
...
|====================
|Annotation  | Meaning
|@Query      | Do not fetch the related object(s) together with the entity.
...
|====================
|Annotation  | Meaning
|@Query      | Do not fetch value together with the transfer object.
...
|====================
|Annotation  | Meaning
|@Query      | Do not fetch the related object(s) together with the transfer object.
...
|====================
|Annotation | Meaning
|@Query     | Do not fetch the related view together with the view.
...
|====================
|Annotation | Meaning
|@Query     | Do not fetch the related rows together with the view.
