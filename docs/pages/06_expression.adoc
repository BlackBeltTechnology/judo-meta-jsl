...
[#string_functions,judo-req="true"]
=== String functions
...
[#numeric_functions,judo-req="true"]
=== Numeric functions
...
[#boolean_functions,judo-req="true"]
=== Boolean functions
...
[#timestamp_functions,judo-req="true"]
=== Timestamp functions
...
[#binary_functions,judo-req="true"]
=== Binary functions
...
[#enumeration_functions,judo-req="true"]
