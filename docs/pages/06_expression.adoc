...
[source,jsl]
----
self.orders!filter(order | order.price > 100);
----

In the example above, we navigate to a collection orders and we filter the orders that are more expensive than 100. In the filter, we first define an iterator variable named `order`. Then, we compare the "price" field of the orders with a static number.
...
[source,jsl]
----
self.orders!filter(order | order.price > 100)!avg(member = price)
----
...
entity Customer {
    ...
    derived Price avgPrice => self.orders!avg(member = price);
...
|`self.country!isDefined()` is `true` if `country` field has a value, otherwise `false`.
|======================================================================
...
|`self.country!isUndefined()` is `false` if `country` field has a value, otherwise `true`.
|======================================================================
...
|Example:
|`self.customer!typeOf(entityType = shop::Customer)` is `true` if `self.customer` is a customer, but neither an enterprise nor a person. For the model, see the xref:01_into.adoc[Introduction] chapter.
|======================================================================
...
|Example:
|`self.customer!kindOf(entityType = shop::Customer)` is `true` if `self.customer` is either a customer, an enterprise, or a person. For the model, see the xref:01_into.adoc[Introduction] chapter.
|======================================================================
...
|Example:
|`self!container(entityType = shop::Customer)` navigates from the Address to the Customer if the container is an instance of Customer or any subtype of Customer (Enterprise or Person). For the model, see the xref:01_into.adoc[Introduction] chapter.
|======================================================================
...
|Example:
|`self.customer!asType(entityType = shop::Enterprise)` navigates from Order to Customer and it returns an Enterprise instance. If the result of the navigation is a Person, it returns undefined. For the model, see the xref:01_into.adoc[Introduction] chapter.
|======================================================================
...
|Example:
|`self!memberOf(shop::Enterprise.orders.orderItems.product)` within a product, it checks whether it has ever been ordered by any enterprise. For the model, see the xref:01_into.adoc[Introduction] chapter.
|======================================================================
...
[options="header",grid="none",cols="1a"]
|======================================================================
|`[purple]#**head(member = **#<member> &#x5B;[purple]##**, reverse = **## <reverse>][purple]##**)**## : collection`
|First, it sorts the given collection by the <member>, and then it returns a collection containing the first elements. If there is more than one element in the first place, all elements in the first place will be included in the result. The <member> is the name of an entity field or derived. The member must have a primitive type. The optional <reverse> is a boolean value. If <reverse> is true the collection will be sorted in descending order, otherwise in ascending order.
| Example:
|`self.orderItems.product!head(member = price, reverse = true)` returns the highest priced products of an order.
|======================================================================

[options="header",grid="none",cols="1a"]
|======================================================================
|`[purple]#**tail(member = **#<member> &#x5B;[purple]##**, reverse = **## <reverse>][purple]##**)**## : collection`
|First, it sorts the given collection by the <member>, and then it returns a collection containing all of the non-first elements. If there is more than one element in the first place, all elements in the first place will be omitted from the result. The <member> is the name of an entity field or derived. The member must have a primitive type. The optional <reverse> is a boolean value. If <reverse> is true the collection will be sorted in descending order, otherwise in ascending order.
|Example:
|`self.orderItems.product!tail(member = price, reverse = true)` returns all products in the order except the highest priced products.
|======================================================================
...
[options="header",grid="none",cols="1a"]
|======================================================================
|`[purple]#**min(member = **#<member>[purple]##**)**## : numeric`
|Returns the minimum value from the set of values selected by the <member>. The <member> is the name of an entity field or derived. The member must have a numeric type.
|Example:
|`self.orderItems!min(member = price)` returns the lowest `price` from the prices of elements of `orderItems` list.
|======================================================================

[options="header",grid="none",cols="1a"]
|======================================================================
|`[purple]#**max(member = **#<member>[purple]##**)**## : numeric`
|Returns the maximum value from the set of values selected by the <member>. The <member> is the name of an entity field or derived. The member must have a numeric type.
|Example:
|`self.orderItems!max(member = price)` returns the highest `price` from the prices of elements of `orderItems` list.
|======================================================================

[options="header",grid="none",cols="1a"]
|======================================================================
|`[purple]#**avg(member = **#<member>[purple]##**)**## : numeric`
|Returns the average of the set of values selected by the <member>. The <member> is the name of an entity field or derived. The member must have a numeric type.
|Example:
|`self.orderItems!avg(member = price)` returns the average `price` of the elements of `orderItems` list.
|======================================================================

[options="header",grid="none",cols="1a"]
|======================================================================
|`[purple]#**sum(member = **#<member>[purple]##**)**## : numeric`
|Returns the sum of the set of values selected by the <member>. The <member> is the name of an entity field or derived. The member must have a numeric type.
|Example:
|`self.orderItems!sum(member = price)` returns the sum of `price` of the elements of `orderItems` list.
|======================================================================
