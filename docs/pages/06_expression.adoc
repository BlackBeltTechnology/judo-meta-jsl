...
derived Products[] orderedProducts => shop::Order.items.product;

// a navigation starting from self variable in Order entity
derived Products[] orderedProducts => self.items.product;
----
...
[source,jsl]
----
derived Integer count => self.items!size();
derived Integer nameLength => self.fullName!size();
----

The `self.items!size()` evaluates to an integer, it returns the number of the ordered items in the order. The expression `self.fullName!size()` will return the number of characters in the customers's name field (assuming it is a String type).
...
entity Customer {
    ...
    derived Price avgPrice => self.orders!avg(order | oorder.price);
...
|Example: `self.orderItems!min(field = price)` returns the lowest `price` from the prices of elements of `orderItems` list.
|======================================================================
...
|Example: `self.orderItems!max(field = price)` returns the highest `price` from the prices of elements of `orderItems` list.
|======================================================================
...
|Example: `self.orderItems!avg(field = price)` returns the average `price` of the elements of `orderItems` list.
|======================================================================
...
|Example: `self.orderItems!sum(field = price)` returns the sum of `price` of the elements of `orderItems` list.
|======================================================================
