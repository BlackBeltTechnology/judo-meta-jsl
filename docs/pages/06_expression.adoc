...
|Returns the container of the instance if that matches the given <entityType>. Container is the owner of the xref:05_entity.adoc[Composition]. Type matching works according to the `kindOf()` function.
|Example:
