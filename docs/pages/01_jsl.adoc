...
[subs="quotes"]
----
[purple]#**relation**# &#x5B;[purple]##**required**##] &lt;entity>&#x5B;[purple]##**[]**##] &lt;name> [purple]##**opposite**## &lt;opposite>
----
...
[subs="quotes"]
----
[purple]#**relation**# &#x5B;[purple]##**required**##] &lt;entity>&#x5B;[purple]##**[]**##] &lt;name> [purple]##**opposite-add**## &lt;opposite>&#x5B;[purple]##**[]**##]
----
...
A composition or composite field is a member whose type is an entity. A composition can be considered as a specific type of relation where the owner of the composition contains the referenced entity instance(s).
...
Derived members provide a flexible mechanism to read their value. The value of a derived member can not set, in other words derived members are read only. However, derived members can be read as if they are stored fields, but they have a special expressions called getter expression. The getter expression is used to return the value of the derived member.
