...
[options="header",grid="none",cols="1a"]
|======================================================================
|`[purple]#**head(**#<selector> [purple]#**=**# &#x5B;[purple]##**ASC**##\|[purple]##**DESC**##][purple]##**,**## ...[purple]##**)**## : collection`
|First, it sorts the given collection by the list of selectors, and then it returns a collection containing the first elements. The selector can the name of any primitive field or primitive derived of the given entity type. If there is more than one element in the first place (due to the equality of the fields), all elements in the first place will be included in the result.
| Example: `self.orderDetails!head(price = DESC, quantity = ASC)`
| The example above selects the highest price item of the order. If there are several items with the same price on the top, it chooses the one with the least number of products in it (lowest quantity). If two or more items have the same price and quantity, it will return them all.
|======================================================================

[options="header",grid="none",cols="1a"]
|======================================================================
|`[purple]#**tail(**#<selector> [purple]#**=**# &#x5B;[purple]##**ASC**##\|[purple]##**DESC**##][purple]##**,**## ...[purple]##**)**## : collection`
...
| Example: `SalesPerson!tail(nrOfContracts = DESC)`
| The example above selects all salespeople who are not the most successful.
|======================================================================
