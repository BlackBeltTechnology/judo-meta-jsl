...
[subs="quotes"]
----
[purple]#**type string**# &lt;name> [purple]#**(min-length =**# &lt;min>[purple]#**, max-length =**# &lt;max>&#x5B;[purple]##**, regex =**## &lt;regular expression>][purple]#**)**#
----

where the <name> is the name of the domain model string, and the mandatory <min> and <max> specify the minimum and the maximum length of the text that can be stored. Both <min> and <max> must be between 1 and 4000, and <min> cannot be greater than <max>.
...
|Example: `"apple"!like(pattern = "%pl_")` is `true`
|======================================================================
...
|Example: `"apPLe"!ilike(pattern = "_pple")` is `true`
|======================================================================
