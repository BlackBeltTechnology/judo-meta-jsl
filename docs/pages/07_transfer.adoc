...
Use the `field` keyword to specify a field within a transfer object. The full list of modifiers can be found in the xref:appx_modifiers.adoc#transfer-field-modifiers[Appendix].
...
Use the `relation` keyword to specify a relation between two transfer objects. The full list of modifiers can be found in the xref:appx_modifiers.adoc#transfer-relation-modifiers[Appendix].
...
A mapped field is a simple field with a mapping configuration. The full list of modifiers can be found in the xref:appx_modifiers.adoc#transfer-field-modifiers[Appendix].
...
So far, expressions returned primitive values. The following example shows a relation that is mapped to one of the entity's relations. The full list of modifiers can be found in the xref:appx_modifiers.adoc#transfer-relation-modifiers[Appendix].
