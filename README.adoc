...
- model - XText language definition and coresponding impmelentations for scoping and code assists.
It is plays as  eclipse plugin. It contains the model and ecore generated java classes.
...
- server-web - A simple web servlet and ice based editor to sandbzox the
