    ...
    def void testInstaceQueriesWithConstantDefaultValues() {
         '''model modelTC024;
            ...
            entity ParentEntity {
                ...
                relation MyEntity queryByTimestamp(Timestamp p1 = `2019-07-18T11:11:12.003+02:00`) <=
                    self.otherEntities
                    !filter(e | e.fldCreated <= p1)
                    !any();
                
                relation MyEntity queryByBoolean(Boolean p1 = false) <=
                    self.otherEntities
                    !filter(e | e.fldBool == p1)
                    !any();
                
                relation MyEntity queryByDate(Date p1 = `2019-07-18`) <=
                    self.otherEntities
                    !filter(e | e.fldDate == p1)
                    !any();
                
                relation MyEntity queryByTime(Time p1 = `11:11:12`) <=
                    self.otherEntities
                    !filter(e | e.fldTime == p1)
                    !any();
                
                relation MyEntity queryByLong(Long p1 = 9999) <=
                    self.otherEntities
                    !filter(e | e.fldLong == p1)
                    !any();
                
                relation MyEntity queryByString(String p1 = "Lorem ipsum") <=
                    self.otherEntities
                    !filter(e | e.fldString == p1)
                    !any();
                
                relation MyEntity queryByDecimal(Decimal p1 = -1526.225) <=
                    self.otherEntities
                    !filter(e | e.fldDecimal == p1)
                    !any();
                
                relation MyEntity queryByMyEnum(MyEnum p1 = MyEnum#A00) <=
                    self.otherEntities
    ...
    def void testInstaceQueriesWithMoreParameterWithConstantDefaultValues() {
         '''model modelTC025;
            ...
            entity ParentEntity {
                ...
                relation MyEntity queryWithMoreParam001(
                ...
                relation MyEntity queryWithMoreParam002(
                    Date p1 = `2019-07-18`,
                    Time p2 = `11:11:12`,
                ...
                relation MyEntity queryWithMoreParam003(
                ...
                relation MyEntity[] setOfMyEntities(
