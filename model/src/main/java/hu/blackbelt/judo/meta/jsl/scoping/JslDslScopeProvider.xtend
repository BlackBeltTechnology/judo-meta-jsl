...
//			EntityRelationOppositeReferenced case ref == JsldslPackage::eINSTANCE.entityRelationOppositeReferenced_OppositeType: this.scope_FilterByEClassifier(scope, JsldslPackage::eINSTANCE.entityRelationDeclaration)
